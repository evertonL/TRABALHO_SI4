...
public class PacienteDAO {
	...
	public ArrayList<PacienteTO> populatePaciente() throws PacienteException{
		...
		try{
				...
				while(rs.next()){
					PacienteTO paciente = new PacienteTO(rs.getString(1), rs.getString(2), rs.getString(3), rs.getDate(4));	
					list.add(paciente);
				}
